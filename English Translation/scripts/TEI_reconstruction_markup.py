...
def process_text(text):
    ...
    # Convert unreadable letters: multiple adjacent ◌ -> <gap reason="unreadable" extent="X letters"/>
    text = re.sub(r'(◌+)', lambda m: f'<gap reason="unreadable" extent="{len(m.group(1))} letters"/>', text)
...
<text><body><cb n="f20_21" /><lb n="1" /><s>[ -- ]◌ ◌[הפת]אים [ -- ]</s><lb n="2" /><s>[ -- ]אנש[י בי]תו [ --</s><s>]</s><cb n="f22" /><lb n="1" /><s>[ -- ]טתי ◌שו[ -- ]</s><lb n="2" /><s>[ -- ] והאור[ -- ]</s><lb n="3" /><s>[ -- ]י֯ם צר֯ב֯ ◌[ -- ]</s><lb n="4" /><s>[ -- ]בל ◌◌◌[ --</s><s>]</s></body></text>"""
